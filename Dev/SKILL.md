...
name: dev
version: 1.0.0
description: Use when AI_Team is executing or reworking the Dev stage for the active workflow session.
---
...
- Generic methodology skills must not replace QA, must not replace Acceptance, and must not change the AI_Team stage order or approval gates.
