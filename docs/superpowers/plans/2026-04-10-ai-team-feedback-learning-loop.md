# AI_Team Feedback Learning Loop Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Add actionable rework routing for QA and Acceptance failures, plus a human-feedback learning intake, so AI_Team can feed downstream defects back into Product/Dev and write standardized learning overlays.
...
```bash
git add ai_company/models.py ai_company/state.py ai_company/cli.py tests/test_state.py tests/test_cli.py
...
**Files:**
- Modify: `ai_company/backend.py`
- Modify: `ai_company/orchestrator.py`
- Modify: `tests/test_orchestrator.py`
- Test: `tests/test_orchestrator.py`
...
```bash
git add ai_company/backend.py ai_company/orchestrator.py tests/test_orchestrator.py
...
```bash
git add QA/SKILL.md Acceptance/SKILL.md Dev/SKILL.md README.md README_zh.md SKILL.md codex-skill/ai-company-workflow/SKILL.md tests/test_docs.py tests/test_skill_package.py
