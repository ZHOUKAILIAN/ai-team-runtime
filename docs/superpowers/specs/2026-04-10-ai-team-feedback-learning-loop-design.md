...
```text
python3 -m ai_company record-feedback \
...
- `ai_company/cli.py`
- `ai_company/orchestrator.py`
- `ai_company/backend.py`
- `ai_company/state.py`
...
- `README.md`
- `README_zh.md`
- `codex-skill/ai-company-workflow/SKILL.md`
- `SKILL.md`
