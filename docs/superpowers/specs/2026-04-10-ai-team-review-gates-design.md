# AI_Team Review Gates Design

## Goal

Harden AI_Team so review-driven workflows are enforced through machine-readable contracts and completion gates instead of relying on conversational judgment.
...
- require review outputs that line up with AI_Team's acceptance contract
...
- AI_Team cannot silently skip a requested review method
- environment mutations require explicit permission
- `figma-restoration-review` becomes stricter, clearer, and easier to integrate into AI_Team acceptance gates
