...
- 本次不重新生成 `agent-team/project/`、`docs/project-runtime/`、`docs/governance/` 等仓库内五层文档。
...
创建新 worktree 时，应该从源工作区的 `.agent-team/` 复制以下本地支持内容到新 worktree：
...
7. 将源工作区的 AGT 本地支持状态复制到新 worktree 的 `.agent-team/`。
