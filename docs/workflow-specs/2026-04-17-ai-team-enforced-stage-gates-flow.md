...
`ai-team` 持有 workflow 状态真相，worker 只能提交候选结果，只有 runtime gatekeeper 才能把候选结果转成可通过的 stage transition。
...
stateDiagram-v2
    [*] --> READY
    READY --> RUNNING: "ai-team acquire-stage-run"
    RUNNING --> SUBMITTED: "worker submits candidate bundle"
    SUBMITTED --> VERIFYING: "ai-team verify-stage-result"
...
表示 runtime 开始验证 worker 提交的 candidate result。这个状态由 `ai-team verify-stage-result` 触发。
...
#### 3. `ai-team build-stage-contract`
...
2. 再看 [2026-04-17-ai-team-enforced-stage-gates-design.md](/Users/zhoukailian/Desktop/mySelf/ai-team-runtime/docs/superpowers/specs/2026-04-17-ai-team-enforced-stage-gates-design.md)，理解详细设计
3. 最后对照 [2026-04-11-ai-team-cli-runtime-flow.md](/Users/zhoukailian/Desktop/mySelf/ai-team-runtime/docs/workflow-specs/2026-04-11-ai-team-cli-runtime-flow.md)，看当前实现在哪里还偏弱
