# AI_Team CLI Runtime 设计说明

日期：2026-04-11

## 设计目标

`AI_Team` 的新目标不是继续强化 skill 提示词，而是成为一个通过 CLI 暴露、对 AI 友好的工程化团队运行时。
...
`AI_Team` 是一个 AI team orchestration runtime。
...
`AI_Team` 是一个通过 CLI 驱动的 AI team orchestration runtime。
