...
if ! command -v git >/dev/null 2>&1; then
  echo "git is required to install ai-company-workflow" >&2
  exit 1
fi
...
echo "Installed vendored AI Team runtime to ${VENDOR_DIR}"
echo "Installed ai-company-workflow skill to ${CODEX_HOME_DIR}/skills/ai-company-workflow"
